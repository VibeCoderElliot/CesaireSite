...
function mapView() {
 ...
 const items=rows.map(o=>{const osm='https://www.openstreetmap.org/?mlat='+Number(o.latitude).toFixed(6)+'&mlon='+Number(o.longitude).toFixed(6)+'#map=17/'+Number(o.latitude).toFixed(6)+'/'+Number(o.longitude).toFixed(6);return '<article class="map-item" id="map-org-'+e(o.id)+'">'+(o.sample?'<span class="demo-label">Fiche de démonstration</span>':'')+'<h2>'+e(o.name)+'</h2><p>'+e(o.address)+'</p><p>'+e(o.metro)+'</p><a href="'+osm+'" target="_blank" rel="noopener noreferrer">Ouvrir dans OpenStreetMap ↗</a>'+(o.source?'<br><a href="'+e(o.source)+'" target="_blank" rel="noopener noreferrer">Source de l’adresse ↗</a>':'')+'</article>';}).join('');
